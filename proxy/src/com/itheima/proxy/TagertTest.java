...
public class TagertTest {
	...
	public void test3() {
		...
		ITarget targetProxy= (ITarget) Proxy.newProxyInstance(target.getClass().getClassLoader(), target.getClass().getInterfaces(), (InvocationHandler) new InvocationHandler(){
