...
//	@Override
	...
	public void add(Product p) {
		QueryRunner runner = new QueryRunner(JdbcUtils.getDataSource());
	    try {
			runner.update("insert into product values(null,?,?,?,?,null)",
					p.getProNum(),p.getProNum(),p.getProName(),p.getProLimit(),p.getAnnualized());
	...
	public void update(Product p) throws SQLException {
		...
		runner.update("sql",p.getProNum(),p.getProName(),p.getAnnualized(),p.getProLimit(),p.getId() );
	}
